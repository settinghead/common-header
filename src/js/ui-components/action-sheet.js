...
angular.module("risevision.common.header")
  .directive("actionSheet", ["$document", "$compile", function($document, $compile) {
    return {
      ...
      link: function (scope, iElement, iAttrs) {
        ...
        var angularDomEl = angular.element("<div class=\"action-sheet\"><ng-include replace-include src=\"templateUrl\"></ng-include></div>");
  ...
  .directive("actionList", ["$document", function($document) {
    return {
      restrict: "A",
